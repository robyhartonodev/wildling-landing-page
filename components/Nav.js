    ...
    <nav className="">
      <div className="bg-hero-wildling h-full">
        ...
        <div className="flex items-center justify-between px-24 py-6">
          {/* Wildling */}
          <div className="flex font-bold font-custom text-brandcolor text-xl">
            WILDLING
          </div>
          {/* Navigation item */}
        ...
        <div className="flex justify-center mt-16">
          <div className="text-7xl text-brandcolor font-bold">
        ...
        <div className="grid grid-cols-3 gap-6 px-20 py-12 text-brandcolor">
          <div>
            <div className="font-custom mb-4">
              It increases circulation and improves lymphatic function,
              resulting in a natural dewy, glowing complexion.
            </div>
            <div className="font-custom mb-6">
              Gua Sha can also be used to prevent and clear acne, decongesting
